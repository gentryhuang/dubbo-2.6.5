...
public class Bytes {
     ...
     * short 转为 字节数组
     * 说明：
     * 1 一个short 占2个字节，即16位，一个byte占1个字节，即8位。一个short需要2个byte存储
     * 2 -9541 对应的原码/反码/补码分别为：1010010101000101/1101101010111010/1101101010111011
     *
     *
     * @param v value.
     * @param b byte array.
    ...
    public static void short2bytes(short v, byte[] b, int off) {
        /**
         * 3 short 转 byte，由于目标类型的长度小于源类型的长度，则直接截取目标类型的长度，即取short的低8位，即-9541补码的低8位 = 1011 1011
         * 3.1 1011 1011 对应的原码为： 1011 1011 - 1 -> 1011 1010  -> 符号位不变，其余取反 -> 1100 0101 -> -69  （也可以正向计算：先求返码 -> 1100 0100，再求补码 -> 1100 0101 ）
         */
        b[off + 1] = (byte) v;
        /**
         * 4 short无符号右移动，即 -9541 对应的补码 1101101010111011 无符号右移8位，得 0000 0000 1101 1010 -> 16777178
         * 4.1 移位后的结果强转位byte，由于目标类型的长度小于源类型的长度，则直接截取目标类型的长度，即取short的低8位，即 1101 1010
         * 4.2 1101 1010 对应的源码为：1101 1010 - 1 -> 1101 1001 -> 符号位不变，其余取反 -> 1010 0110 -> -38
         */
        b[off + 0] = (byte) (v >>> 8);
    }
